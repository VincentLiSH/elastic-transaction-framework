...
import cn.panshi.etf4j.robust.EtfRobDaoRedis.ETF_ROB_REDIS_KEYS;
import cn.panshi.etf4j.robust.demo.EtfDemoComponent;
import cn.panshi.etf4j.robust.demo.EtfDemoEnum;
import cn.panshi.etf4j.robust.demo.EtfDemoVo;
...
public class EtfRobustTxTemplateTest {
	Logger logger = Logger.getLogger(EtfRobustTxTemplateTest.class);
	@Resource
